...
hoistedDependencies:
  ...
  /create-jest/29.7.0(@types/node@20.19.10):
    create-jest: private
  /cross-spawn/7.0.6:
    cross-spawn: private
  /debug/4.4.1:
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@20.19.10):
    jest-cli: private
  /jest-config/29.7.0(@types/node@20.19.10):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sat, 09 Aug 2025 13:23:42 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/ryanmay/Library/pnpm/store/v3
