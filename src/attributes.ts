import { HandleableEvents } from "./recordConfigs";
...
export type AttributeConstruction = {
   ...
   */
  obtainImage?: (event: HandleableEvents) => object | undefined;
 ...
 * readability. 
 */
export const heidiAttribute = (props: AttributeConstruction): ConstructedAttribute => {
  return {
